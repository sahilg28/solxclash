/*
  # Add Profile Fields and Daily Streak System

  1. New Profile Fields
    - `country` (text, nullable) - User's country
    - `last_played_date` (date, nullable) - Last date user made a prediction
    - `daily_play_streak` (integer, default 0) - Current consecutive days played
    - `last_seven_day_reward_date` (date, nullable) - Last date user received 7-day streak reward

  2. Daily Streak Logic
    - Users get streak for playing at least one game per day
    - 7 consecutive days = 300 XP reward
    - Streak resets if user doesn't play for a day
*/
