...
const FeaturedGame = () => {
  return (
    <section data-section="featured-games" className="py-20 bg-gradient-to-b from-purple-900/30 via-purple-900/10 to-black">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-blue-900/40 to-black/80 backdrop-blur-xl border border-blue-400/30 rounded-3xl p-6 lg:p-8 shadow-2xl animate-scale-in">
            ...
            <div className="relative z-10">
              ...
              <button 
                className="w-full group bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2"
