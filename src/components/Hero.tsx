...
const Hero = () => {
  ...
  const scrollToFeaturedGames = () => {
    const section = document.querySelector('section'); // This will find the first section after Hero
    const featuredSection = document.querySelector('[data-section="featured-games"]') || 
                           document.querySelector('section:nth-of-type(2)'); // Fallback to second section
    if (featuredSection) {
